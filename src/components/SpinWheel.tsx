  ...
  return (
    <div className="relative flex flex-col items-center py-10">
      ...
      <div className="relative">
        ...
        >
          <svg viewBox="0 0 100 100" className="w-full h-full transform scale-[1.02]">
            ...
            {/* المركز - رمز Pi المحدث للوضوح الأقصى */}
            <g className="filter drop-shadow-[0_0_15px_rgba(251,191,36,0.6)]">
              ...
              {/* رسم الرمز π بشكل مستقيم وعريض */}
              <g transform="translate(37, 39) scale(0.26)" filter="url(#inner-glow)">
                {/* الخط العلوي: جعلناه عريضاً ومستقيماً تماماً ليظهر كشعار */}
                <rect x="5" y="10" width="90" height="15" rx="4" fill="url(#pi-metal-grad)" />
                
                {/* الرجل اليسرى: سميكة مع انحناء بسيط جداً بالأسفل */}
                <path d="M30 25 L 30 75 Q 30 90 5 90" stroke="url(#pi-metal-grad)" strokeWidth="15" fill="none" strokeLinecap="round" />
                
                {/* الرجل اليمنى: مستقيمة وقوية لثبات التصميم */}
                <path d="M70 25 L 70 90" stroke="url(#pi-metal-grad)" strokeWidth="15" fill="none" strokeLinecap="round" />
              </g>
      ...
      <motion.div className="mt-12 text-center">
        <div className="w-40 h-[1px] bg-gradient-to-r from-transparent via-gold/50 to-transparent mx-auto mb-4" />
