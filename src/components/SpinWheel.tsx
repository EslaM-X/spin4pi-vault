      ...
      <div className="relative">
        ...
        >
          <svg viewBox="0 0 100 100" className="w-full h-full transform scale-[1.02]">
            ...
            {/* الدائرة المركزية مع رمز Pi النصي فائق الوضوح */}
            <g>
              <circle cx="50" cy="50" r="14" fill="url(#royal-core-bg)" stroke="#fbbf24" strokeWidth="1" />
              <circle cx="50" cy="50" r="12" fill="transparent" stroke="#fbbf24" strokeWidth="0.2" strokeDasharray="2,2" className="animate-[spin_20s_linear_infinite]" opacity="0.5" />
              
              {/* تعديل رمز Pi ليكون نصاً حقيقياً لضمان الوضوح التام */}
              <text
                x="50"
                y="52"
